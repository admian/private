    ...
    <div id="dub">
        <div class="bgOpacity">
          ...
          <div class="banner">
           ...
           <div  class="image">
            <img :src="baseUrl +bannerList.imageUrl">
           </div>
          </div>
        </div>
      <!------------------------------------------------------------------------------------>
      <div>
        ...
        <div class="bob" v-for="(item,index) in dubList" :key="index">
          <div class="bobtop">
            ...
            <div class="sum fr">
              <router-link :to="'/dubDetails?id='+item.id"><i class="sumi">{{item.productionCount}} >></i></router-link>
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in item.productionList">
                  <router-link :to="'/dubDetails?dubId='+i.id" class="user-info clearfix">
    ...
    export default {
      ...
      methods:{
        ...
        getData: function (isEmpty) {
          let limit = 10;
          this.$post('/api/offline/dub/queryProductionTypeInfoList', {
            limit: limit,
            page: this.pageIndex
          }, true).then(res => {
