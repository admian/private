...
;( function( window ) {
	...
	ElastiStack.prototype._setStackStyle = function() {
		...
		if( item2 ) {
			...
			setTransformStyle( item2, is3d ? 'translate3d(0,0,-15px)' : 'translate(0,0)' );
		}

		if( item3 ) {
			item3.style.opacity = 1;
			item3.style.zIndex = 2;
			setTransformStyle( item3, is3d ? 'translate3d(0,0,-30px)' : 'translate(0,0)' );
		}
	};
    ...
    //1.删除最上层卡片后，加载下一个
		...
		var self = this,
			onEndTransFn = function() {
				...
				// reset first item
				setTransformStyle( instance.element, is3d ? 'translate3d(0,0,-120px)' : 'translate(0,0,0)' );
	...
	ElastiStack.prototype._onDragMove = function( instance, event, pointer ) {
		if( this._outOfBounds( instance ) ) {
			...
			var item2 = this._secondItem(), item3 = this._thirdItem();
			if( item2 ) {
        setTransformStyle( item2, is3d ? 'translate3d(' +'0' + 'px,' + '0' + 'px, -15px)' : 'translate(' + '0'+ 'px,' + '0' + 'px)' );
			...
			if( item3 ) {
        setTransformStyle( item3, is3d ? 'translate3d(' + '0' + 'px,' + '0' + 'px, -30px)' : 'translate(' + '0' + 'px,' + '0' + 'px)' );
