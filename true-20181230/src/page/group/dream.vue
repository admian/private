<template>
  ...
  <div id="dream">
    <div class="bgOpacity">
      <img src="../../assets/img/dream/bg.gif" class="bg"><!--png-->
      <!--<div class="zIndex">-->
        <div class="tabs">
        ...
        <div class="banner">
          <Carousel v-model="value" loop autoplay :autoplay-speed="4000">
            <CarouselItem v-for="item,index in bannerList" :key="index">
              ...
              <!--<div class="demo-carousel"><img src="../../assets/img/dream/banner/dream.png" :alt="item.description"></div>-->
            </CarouselItem>
          </Carousel>
        </div>
      <!--</div>-->
    ...
    <div class="selectAct" v-for="(item,index) in actList" :key="index">
        ...
        <div class="contentAct fcolor1">
          <div class="dreamtop">
            ...
            <div class="sum fr">
             <router-link class="sumi" :to="'/activityDetails?dreamId='+item.id+'&&dreamPush=dream'+'&&description='+item.description">{{item.productionCount}} >></router-link>
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in item.productionList">
                  ...
                  <router-link :to="'/activityDetails?id='+i.id+'&&dreamType='+item.id+'&&dreamPush=dream'+'&&description='+item.description">
                      <!--封面-->
    ...
    name: "Dream",
      ...
      methods:{
        ...
        getData(isEmpty) {
           let limit = 10;
           //获取梦想活动列表
           this.$post('/api/offline/dream/queryDreamInfoList', {pageSize: limit, pageNum: this.pageIndex}).then(res => {
             //
