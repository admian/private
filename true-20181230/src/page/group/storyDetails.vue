<template>
  <div id='storyDetails'>
    ...
    <div class="start-info">
      ...
      <p style="white-space: pre-wrap;word-wrap: break-word;" class="story-connect">{{storeInfo.storyBody}}</p>
        ...
        <div class="reply clearfix" v-if="i.storyEvaluateReplies">
          <ul>
            <li v-for="k,indexK in i.storyEvaluateReplies" :key="indexK">
              <router-link class="link" :to="'/person?userId='+k.userId">{{k.nickName}}</router-link>
    ...
    <div class="comment_info">
      <!--<p class="comment_user" v-show="">回复@ <span>{{}}</span></p>-->
    ...
    methods: {
      ...
      clickFocus(id, isAttention) {
        ...
        this.$post('/api/user/saveUserAttention/' + id).then(res => {
          if(isAttention){
            this.storeInfo.isAttention=false;
          }else{
