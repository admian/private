           ...
           <div  class="image">
            <Carousel v-model="value" loop autoplay :autoplay-speed="4000">
               <CarouselItem v-for="item,index in bannerList" :key="index">
                 ...
                 <!--<div class="demo-carousel"><img src="../../assets/img/dream/banner/dub.png" :alt="item.description"></div>-->
               </CarouselItem>
             </Carousel>
      ...
      <div>
        <div class="bob" v-for="(item,index) in dubList" :key="index">
          <div class="bobtop">
            ...
            <div class="sum fr">
              <router-link :to="'/dubDetails?dubId='+item.id+'&&description='+item.name"><i class="sumi">{{item.productionCount}} >></i></router-link>
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in item.productionList">
                  <router-link :to="'/dubDetails?id='+i.id+'&&description='+item.name" class="user-info clearfix">
    ...
    export default {
      ...
      methods:{
        ...
        getData: function (isEmpty) {
          let limit = 10;
          this.$post('/api/offline/dub/queryProductionTypeInfoList', {channelId: 2,pageSize: limit, pageNum: this.pageIndex}, true).then(res => {
