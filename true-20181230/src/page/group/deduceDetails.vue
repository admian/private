...
<!--        <div id="video-container" style="margin: 0px auto;"  @click="playVideo">
      ...
      <div class="recommended">
        <div class="slider-wrap">
          <ul class="list-nav clearfix">
            <li class="fl" :class="routerType ?'list-item_imp' :'list-item'" v-for="i,index in list" :key="index" >
...
<style>
  #deduceDetails .vux-popup-dialog {
    background: #33254C;
  }
  #deduceDetails  #video-container{
    position: relative;
  }
  #deduceDetails .vcp-controls-panel{ /*整体*/
    position: absolute;
    height: 100%;
  }
  #deduceDetails .vcp-panel-bg{/*背景*/
    position: absolute;
    z-index:1;
    display: none;
  }
  #deduceDetails .vcp-timelabel, .vcp-volume{  /*时间*/
    z-index:10;
    display: none;
    /*border: 1px solid red;*/
  }
  #deduceDetails .vcp-timeline{/*控制条*/
    position: absolute;
    top:97%;
    z-index: 10;
    display: none;
  }
  #deduceDetails .vcp-playtoggle{ /*播放*/
  ...
  #deduceDetails .vcp-player{
    background-color: transparent;
  }
  #deduceDetails .vcp-fullscreen-toggle{
    display: none;
  }
</style>
<style scoped>
  ...
  /*--------------------------------视频------------------------------------------------*/
   .video-con_s{padding:0 0 .7rem; position: relative;}
   .video-con_h{padding:1.5rem 0 2rem 0; position: relative;}
   .video-s{
     width: 5.24rem;
     height: 7.02rem;
     margin: auto 0;
