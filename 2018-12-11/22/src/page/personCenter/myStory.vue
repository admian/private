                ...
                <div class="connect-wrap" >
                  ...
                  <router-link :to="'/storyDetails?id='+item.id">
                    <div class="con-item" v-for="(i,index) in item.list" :key="index"><!---->
                      ...
                      <div class="num-list">
                        <span><img src="../../assets/img/self/leave_ico.png" class="leave-icon">{{i.evaluateCount}}</span>
                        <span><img src="../../assets/img/self/like_ico.png" class="like-ico">{{i.favoriteCount}}</span>
                      </div>
                    </div>
                  </router-link>
                </div>
  ...
  export default {
    ...
    methods: {
      ...
      getData(isEmpty) {
        ...
        //评论
        this.$post('/api/story/queryAllUserStoryEvaluateByPage', {pageSize: limit, pageNum: this.pageIndex}).then(res => {
          this.isLoading = false
          let arr = [];
        ...
        //喜欢
        this.$post('/api/story/queryAllAttentionUserStoryByPage', {pageSize: limit, pageNum: this.pageIndex}).then(res => {
          this.isLoading = false
          if (isEmpty) {
