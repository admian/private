<script src="../../../../wenting/src/utils/detect-prefixes.js"></script>
<template>
    <div id="dub">
        <div class="bgOpacity">
          <div class="tabs">
          ...
          <div class="dubbanner">
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in 5">
                  <img src="" class="pic">
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in 4">
                  <img src="" class="pic">
                  <div class="play-wrap"><x-play></x-play></div>
                  <!--<span class="play-ico"><img src="../../assets/img/dub/play.png" class="play-image"></span>-->
                  <div class="user-info clearfix">
                    <img class="user-ico fl" src="">
                    <span class="user-name fl">拜托啦学妹</span>
                  </div>
