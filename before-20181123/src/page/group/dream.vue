<template>
        ...
        <div class="banner">
          <Carousel v-model="value" loop autoplay :autoplay-speed="4000">
            <CarouselItem v-for="item,index in bannerList" :key="index">
              <div class="demo-carousel"><img :src="item.imageUrl" :alt="item.description"></div>
            </CarouselItem>
           <!-- <CarouselItem>
  ...
  <!-- <scroller v-model="scrollerStatus" height="-46" lock-x scrollbar-y ref="scroller" :bounce="true"
      ...
      <div class="selectAct" v-for="(item,index) in actList" :key="index">
        <!--主题背景-->
        <img :src="item.dreamCover" class="bgImg">
        ...
        <div class="contentAct fcolor1">
          <div class="dreamtop">
            ...
            <div class="sum fr">
             <router-link class="sumi" :to="'/activityDetails?dreamId='+item.id+'&&dreamPush=dream'">{{item.productionCount}} >></router-link>
            ...
            <div class="list-info-wrap">
              <ul class="list-info clearfix">
                <li class="list-info-item fl" v-for="i in item.productionList">
                  ...
                  <router-link :to="'/activityDetails?id='+i.id+'&&dreamType='+item.id+'&&dreamPush=dream'">
                      <!--封面-->
                    ...
                    <router-link :to="'/person?userId='+i.userId" class="recom clearfix">
                      <div class="fl recoml">
                        ...
                        <span class="remNo" v-if="i.orders">no.{{i.orders}}</span>
                      </div>
                      <div class="fl recomr">
