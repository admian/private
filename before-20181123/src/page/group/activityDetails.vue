...
-->
        ...
        <!--push动效暂用图片-->
        <!--<div class="live" v-if="activeInfo.dreamId">
          <img @click="push" src="../../assets/img/push.png">
          <span></span>
          <span></span>
        </div>-->
       <!-- <img
          :src="isPush ? require('../../assets/img/push2.gif'):require('../../assets/img/push1.gif')"
          class="icon-push" @click="push"
          v-if="dreamPush">-->
        <div class="icon-push" @click="push">
      ...
      <div class="actUser clearfix" v-if="activeInfo">
        <div class="fl" >
          <div class="userPhoto fl">
            ...
            <div class="focus" @click="isAttention(activeInfo.userId,activeInfo.isAttention)"><img v-if="!activeInfo.isAttention && activeInfo.userId!=my_userId " src="../../assets/img/dream/focus.png"></div>
          </div>
        ...
        <div class="slider-wrap">
          <ul class="list-nav clearfix">
            <li class="list-item fl" v-for="i,index in list" :key="index" >
             <!--<router-link :to="'/activityDetails?id='+i.id+'&&dreamType='+dreamType">-->
                <img :src="i.productionCover" @click="changeVideo(i.id)">
                <router-link :to="'/person?userId='+i.userId" class="recom clearfix">
                  <div class="fl recoml">
                    <!--<img :src="baseUrl + i.headUrl" class="recomImg">-->
                    <img src="../../assets/img/choice/11.jpg" class="recomImg">
                     <!--<span class="remNo" v-if="i.orders">no.{{i.orders}}</span>d-->
                  </div>
                  <div class="fl recomr">
    ...
    methods: {
      ...
      changeVideo(i) {
       ...
       // console.log(this.activeInfo);
        this.$post('/api/offline/common/getProductionInfoById/' + i, {}).then(res => {
          this.activeInfo = res;
          console.log(res);
       /* this.playerOptions.sources[0].src = res.videoUrl;
          this.playerOptions.poster = res.productionCover;*/
...
<style scoped>
  ...
  .is_act {padding: 1.7rem 0 1.4rem;}
  /*--------------------视频--------------------------*/
  .actVideo {
    height: 7rem;
    margin-top: .4rem;
