    ...
    <div class="connect">
      ...
      <div v-show="key==2">
        <div class="no-connect" v-if="!newReplylist.length">
          ...
          <router-link to="/story"><div class="btn-work">说几句</div></router-link>
        </div>
        <div v-else>
      ...
      <div class="container" v-show="key==3">
        <div class="no-connect" v-if="!attentionList.length">
          ...
          <router-link to="/story"><div class="btn-work">找找看</div></router-link>
        </div>
        <div v-else>
          <ul>
            <li class="like_li" v-for="(item,index) in attentionList" :key="index">
              <router-link :to="'/storyDetails?id='+item.id">
                <div class="fl">
  ...
  export default {
    ...
    methods: {
      ...
      hideTime(index){
        ...
        if(this.stroyList[index].time == this.stroyList[index-1].time){
          return true
        }else{
          return false
        }
